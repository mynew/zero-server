...
WorldSession::WorldSession(uint32 id, WorldSocket *sock, AccountTypes sec, uint32 premium, time_t mute_time, LocaleConstant locale) :
m_muteTime(mute_time),
_player(NULL), m_Socket(sock),_security(sec), _premium(premium), _accountId(id), _logoutTime(0),
